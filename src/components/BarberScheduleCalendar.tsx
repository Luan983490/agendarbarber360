        ...
        <CardContent className="flex flex-col flex-1 overflow-hidden p-2 sm:p-3 lg:p-4 gap-2 min-h-0 rounded-none" style={{ backgroundColor: '#f0f0f0', borderRadius: 0 }}>
          ...
          <div className="flex-1 min-h-0 overflow-hidden flex flex-col" style={{ borderRadius: 0 }}>
            {viewMode === 'month' ? (
              ...
              /* Visualização Dia/Semana - Grade de Horários - scroll unificado com sticky */
              <div 
              ...
              >
                ...
                >
                  <div 
                    ...
                    style={{ width: 48, height: 36, backgroundColor: '#d9d9d9' }}
                  />
                  <div 
                ...
                >
                  {allTimeSlotsForView.map((time) => (
                    <div
                      key={time}
                      className={cn("flex", viewMode === 'week' ? "h-[20px]" : "h-[24px] sm:h-[22px]")}
                    >
                      {/* Time label - sticky left */}
                      <div 
                        className="sticky left-0 z-10 flex-shrink-0 flex items-center justify-end pr-1.5 border-r border-gray-400/10 text-black"
                        style={{ width: 48, fontSize: 11, fontWeight: 500, backgroundColor: '#d9d9d9' }}
                      >
                        {time.substring(0, 5)}
                      </div>
                      {/* Day columns */}
