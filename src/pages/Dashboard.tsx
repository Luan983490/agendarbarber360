...
const Dashboard = () => {
  ...
  const renderContent = () => {
    switch (currentTab) {
      ...
      case 'bookings':
        return (
          <div className="flex-1 min-h-0 flex flex-col gap-3 sm:gap-4" style={{ backgroundColor: '#000000' }}>
            ...
            <div className="flex-1 min-h-0 flex flex-col xl:flex-row gap-4">
              ...
              {/* Painel de Bloqueio - Desktop (com scroll) */}
              <div className="hidden xl:flex xl:flex-col w-72 2xl:w-80 flex-shrink-0 max-h-full overflow-y-auto">
                <BlockSchedulePanel 
                  barbershopId={barbershop!.id} 
                  selectedBarberId={selectedBarber}
